package com.example.uilibrary.chat;
...
public class ChatActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        boolean isGroup = bundle.getBoolean(BaseConstants.IS_GROUP);
        if (isGroup) {
    ...
    public static void startC2CChat(Context context, String chatInfo) {
        ...
        intent.putExtra(BaseConstants.IS_GROUP, false);
        intent.putExtra(BaseConstants.INTENT_DATA, chatInfo);
    ...
    public static void startGroupChat(Context context, String chatInfo) {
        Intent intent = new Intent(context, ChatActivity.class);
        intent.putExtra(BaseConstants.IS_GROUP, true);
        intent.putExtra(BaseConstants.INTENT_DATA, chatInfo);
        context.startActivity(intent);
    }
